...
/**
 * A method that takes in a phraseBook (previously parsed source) and returns a string generated according to the phraseBook.
 * @param {*} phraseBook - A phraseBook of the parsed Seed sketch.
 * @param {*} rootKey - The key to be used as a root. Is 'root' by default, for most applications this should be the value it is set to.
 * @param {*} globalMemory - Used for setting optional variables to be available globaly. If none are needed, empty JSON object is passed in. 
 * @param {*} seed - The value to seed the random generation with. Serves for replicability of generation.
 * @param {*} t - Time.
 */
