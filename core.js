 ...
 * @param {*} conditionalVariables Conditional variables are used for specifying any variables that any of the sketches (regardless of whether it is the main sketch or imported sketches) require to execute correctly.
 * The default value of this parameter is {}.
 */
async function parsePhraseBook(s, loadSketch = 'file', conditionalVariables = {}) {
